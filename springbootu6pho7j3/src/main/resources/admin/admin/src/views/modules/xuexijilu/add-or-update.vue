<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"16px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="科目名称" prop="kemumingcheng">
					<el-input v-model="ruleForm.kemumingcheng" placeholder="科目名称" clearable  :readonly="ro.kemumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="科目名称" prop="kemumingcheng">
					<el-input v-model="ruleForm.kemumingcheng" placeholder="科目名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="学习时长/h" prop="xuexishizhang">
					<el-input-number v-model="ruleForm.xuexishizhang" placeholder="学习时长/h" :disabled="ro.xuexishizhang"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="学习时长/h" prop="xuexishizhang">
					<el-input v-model="ruleForm.xuexishizhang" placeholder="学习时长/h" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="学习时间" prop="xuexishijian">
					<el-date-picker
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.xuexishijian" label="学习时间" prop="xuexishijian">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="学习情况" prop="xuexiqingkuang">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="学习情况"
					  v-model="ruleForm.xuexiqingkuang" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.xuexiqingkuang" label="学习情况" prop="xuexiqingkuang">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xuexiqingkuang}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				xuexishizhang: [
					{ required: true, message: '学习时长/h不能为空', trigger: 'blur' },
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xuexiqingkuang'){
							this.ruleForm.xuexiqingkuang = obj[o];
							this.ro.xuexiqingkuang = true;
							continue;
						}
						if(o=='xuexishijian'){

...
public class FuwupingjiaVO  implements Serializable {
	...
	public void setYijianpingjia(String yijianpingjia) {
		this.yijianpingjia = yijianpingjia;
	}
	
	/**
	 * 获取：意见评价
	 */
	public String getYijianpingjia() {
		return yijianpingjia;
	}
